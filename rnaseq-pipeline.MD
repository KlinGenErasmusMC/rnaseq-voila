...
The mapped reads are counted by bedtools multicov against separate bedfiles for 
genes (GCF_000001405.25_GRCh37.p13_genomic.chr.genes.bed),
exons (GCF_000001405.25_GRCh37.p13_genomic.chr.transcripts.bed) and
introns (GCF_000001405.25_GRCh37.p13_genomic.chr.introns.bed) (see [ref](https://github.com/KlinGenErasmusMC/rnaseq-voila/tree/main/ref).
